...
EGLBoolean eglGetConfigs(   EGLDisplay dpy, EGLConfig *configs, EGLint config_size, EGLint *num_config)
{
    ...
    *num_config = 0;
    ...
    if (cnx->dso) {
        res = cnx->egl.eglGetConfigs(d, configs, config_size, num_config);
    }
...
EGLBoolean eglChooseConfig( EGLDisplay dpy, const EGLint *attrib_list, EGLConfig *configs, EGLint config_size, EGLint *num_config)
{
    ...
    if(attrib_list == NULL){
      ...
      //  l[1] = 0;
        ...
        memcpy(l, attrib_list, 64 * sizeof(EGLint));
    }
   ...
   // *num_config = 0;
    ...
    if (cnx->dso) {
        ...
        res = cnx->egl.eglChooseConfig(iDpy, (const EGLint *) l, configs, config_size, num_config);
...
EGLBoolean eglGetConfigAttrib(EGLDisplay dpy, EGLConfig config, EGLint attribute, EGLint *value)
{
    ...
    return cnx->egl.eglGetConfigAttrib(iDpy, config, attribute, value);
}
...
static android_dataspace modifyBufferDataspace( android_dataspace dataSpace, EGLint colorspace) {
    
#if (ENABLE_EGL_KHR_GL_COLORSPACE != 0)
if(colorspace==EGL_GL_COLORSPACE_KHR)
